...
const IncomeUpdatePopup = ({ open, onClose, incomeData, incomeId }) => {
  ...
  useEffect(() => {
    if (open && incomeData) {
      setAmountRaw(incomeData.amount || 0);
      setAmountDisplay(formatCurrency(incomeData.amount || 0));
      setSelectedCategory(incomeData.sourceCategory || "");
  ...
  const saveData = async (e) => {
    ...
    try {
      ...
      const incomeRef = ref(db, `incomeList/${uid}/${incomeId}`);
      ...
      <div className="bg-white w-full max-w-lg rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={saveData} className="flex flex-col gap-4">
          ...
          <div className="flex justify-end gap-3 mt-2">
            ...
            <button type="submit" disabled={saving} className="px-4 py-2 rounded-full bg-purple-700 text-white">
