...
const ExpenseUpdatePopup = ({ open, onClose, expenseData, expenseId }) => {
  ...
  useEffect(() => {
    if (open && expenseData) {
      setAmountRaw(expenseData.amount || 0);
      setAmountDisplay(formatCurrency(expenseData.amount || 0));
      setSelectedCategory(expenseData.sourceCategory || "");
  ...
  const saveData = async (e) => {
    ...
    try {
      ...
      const expenseRef = ref(db, `expenseList/${uid}/${expenseId}`);
